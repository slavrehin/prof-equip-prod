...
$APPLICATION->SetPageProperty("description", "Комплексное оснащение объектов питания под ключ профессиональным оборудованием для ресторана, кафе, столовой, пекарни. Получить консультацию.");
$APPLICATION->SetPageProperty("title", "Комплексное оснащение ресторанов, кафе и столовых - профессиональное оборудование для кухни");
$APPLICATION->SetTitle("Кухня");
$arProps = GetPropDirectionByCode("kuhnya",GetIBlockIDByCode("kuhnya"));
?>
<?if ($arProps["BANNERS"]):?>
...
<?endif;?>
    ...
    <?$APPLICATION->IncludeComponent(
        ...
        "AJAX_MODE" => "N",
        "IBLOCK_ID" => GetIBlockIDByCode("kuhnya"),
        "ELEMENT_CODE" => "kuhnya",
        "CHECK_DATES" => "Y",
        "FIELD_CODE" => array(
            0 => "ID",

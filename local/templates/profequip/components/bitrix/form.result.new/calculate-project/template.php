...
<?=$arResult["FORM_NOTE"]?>
    ...
    <form class="calculate-project-form form filled fb-form" name="<?=$arResult["WEB_FORM_NAME"];?>" action="/local/ajax/form/" novalidate="novalidate">
        ...
        <button class="btn gradient" type="submit"><span class="btn__text">Рассчитать</span></button>
    </form>
    <?
    } 

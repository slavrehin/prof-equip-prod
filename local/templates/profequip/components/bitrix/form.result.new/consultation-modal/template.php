        ...
        <div class="modal-content"> <button class="btn close-modal">×</button>
            ...
            <form class="form consultation__form fb-form" name="<?=$arResult["WEB_FORM_NAME"];?>" action="/local/ajax/form/">
                ...
                <input type="hidden" name="web_form_submit" value="<?=$arResult["arForm"]["BUTTON"];?>">
                        ...
                        <input type="hidden" name="<?=$arResult["QUESTION_NAME"]["consultation_client_id"];?>" class="js-client-id" value="">
                        <input type="hidden" name="<?=$arResult["QUESTION_NAME"]["consultation_utm_source"];?>" class="js-utm_source" value="">
                        <input type="hidden" name="<?=$arResult["QUESTION_NAME"]["consultation_utm_medium"];?>" class="js-utm_medium" value="">
                        <input type="hidden" name="<?=$arResult["QUESTION_NAME"]["consultation_utm_campaign"];?>" class="js-utm_campaign" value="">
                        <input type="hidden" name="<?=$arResult["QUESTION_NAME"]["consultation_utm_content"];?>" class="js-utm_content" value="">
                        <input type="hidden" name="<?=$arResult["QUESTION_NAME"]["consultation_utm_term"];?>" class="js-utm_term" value="">

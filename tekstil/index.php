...
$APPLICATION->SetPageProperty("description", "Профессиональный текстиль для гостиниц, отелей, ресторанов. Высокая износостойкость, экономичность расходов на стирку. Все ткани сертифицированы. Получить консультацию.");
$APPLICATION->SetPageProperty("title", "Профессиональный текстиль для отелей, ресторанов и гостиниц купить по выгодным ценам");
$APPLICATION->SetTitle("Текстиль для отелей");
$arProps = GetPropDirectionByCode("textile",GetIBlockIDByCode("textile"));
?>
<?if ($arProps["BANNERS"]):?>
...
<?endif;?>
    ...
    <?$APPLICATION->IncludeComponent(
        ...
        "AJAX_MODE" => "N",
        "IBLOCK_ID" => GetIBlockIDByCode("textile"),
        "ELEMENT_CODE" => "textile",
        "CHECK_DATES" => "Y",
        "FIELD_CODE" => array(
            0 => "ID",
            1 => "",
    ...
    ?>
<?endif;?>
<section class="textile-form">
            <div class="textile-form__bg">
                <picture>
                    <source srcset="<?=LAYOUT_DIR?>assets/img/textile-form/bg.webp, <?=LAYOUT_DIR?>assets/img/textile-form/bg@2x.webp 2x" type="image/webp">
                    <img src="<?=LAYOUT_DIR?>assets/img/textile-form/bg.jpg" srcset="<?=LAYOUT_DIR?>assets/img/textile-form/bg.jpg, <?=LAYOUT_DIR?>assets/img/textile-form/bg@2x.jpg 2x" alt="bg">
                </picture>
            </div>
            <div class="textile-form__inner container">
                <h2 class="textile-form__title">ПРОФЕССИОНА­ЛЬНЫЙ ТЕКСТИЛЬ<br>ДЛЯ ОТЕЛЕЙ &amp; РЕСТОРАНОВ</h2>

...
$APPLICATION->SetPageProperty("description", "Заказать комплексное оснащение вашего отеля или гостиницы в Москве и по всей России. Профессиональный текстиль и униформа. Оснащение прачечных и гостиничных номеров.");
$APPLICATION->SetPageProperty("title", "Комплексное оснащение отелей и гостиниц под ключ от компании ПРОФЭКВИП");
$APPLICATION->SetTitle("Комплексное оснащение");
$arProps = GetPropDirectionByCode("equipment",GetIBlockIDByCode("equipment"));
?>
<?if ($arProps["BANNERS"]):?>
...
<?endif;?>
    ...
    <?$APPLICATION->IncludeComponent(
        ...
        "AJAX_MODE" => "N",
        "IBLOCK_ID" => GetIBlockIDByCode("equipment"),
        "ELEMENT_CODE" => "equipment",
        "CHECK_DATES" => "Y",
        "FIELD_CODE" => array(
            0 => "ID",
            1 => "",
